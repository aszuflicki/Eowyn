...
class ActionButtons extends Component {
    ...
    render() {
        if (this.props.isEditMode)
            return (
                <Button floating fab='vertical' icon='close' className='blue' large style={{ bottom: '45px', right: '24px' }}
                >
            ...
            <Fragment>
                ...
                >
                    <Button floating className='red'
                        onClick={() => {
                            if (Object.keys(this.props.layout).length < 2) {
                                toast.warn("You can't delete the only tab");
                            } else {
